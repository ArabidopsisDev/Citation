...
/// <summary>
/// Provides methods for encrypting, decrypting, and hashing data using symmetric cryptography and hashing algorithms.
/// </summary>
/// <remarks>This class supports AES-based encryption and decryption, as well as SHA-256 and MD5 hashing. It also
/// includes utility methods for encoding and decoding data in Base64 format, and for encrypting or decrypting objects
/// by processing their string properties. The class is intended for internal use and is not thread-safe. Key and IV
/// management is handled via constructor parameters or application configuration, and incorrect usage may result in
/// data loss or inability to decrypt previously encrypted data.</remarks>
